...
var helpPage = "http://www.w3c.es/Presentaciones/Slidy/help.html";
var helpText = "Navega mediante clicks, barra espaciadora, Re Pag o Av Pag." +
               " Usa < y > (o - y + en el teclado numérico) para cambiar el tamaño de las fuentes.";
...
{
   slideNumElement.innerHTML = "diapositiva " +
...
function addToolbar()
{
   ...
   if (ns_pos) // a reasonably behaved browser
   {
      ...
      slideCounter.innerHTML = "diapositiva n/m";
      ...
      contents.setAttribute("title", "tabla de contenidos");
      contents.innerHTML = "¿contenidos?";
      ...
      start.setAttribute("title", "¿reiniciar presentación");
   ...
   else // IE so need to work around its poor CSS support
   {
      ...
      var start = document.createElement("a");
      start.setAttribute("href", page);
      start.setAttribute("title", "¿reiniciar la presentación?");
      start.innerHTML = "¿reiniciar?";
...
function tableOfContents()
{
  ...
  heading.innerHTML = "Tabla de Contenidos";
